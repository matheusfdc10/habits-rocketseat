...
const HabitDay = ({defaultCompleted = 0, amount = 0, date}: HabitProps) => {
    ...
    return(
        <Popover.Root>
            <Popover.Trigger 
                className={clsx("w-10 h-10 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:via-violet-600 focus:ring-offset-2 focus:ring-offset-background", {
                    ...
                    'bg-violet-500 border-violet-400 text-zinc-300': completedPercentage >= 80,
